...
139 тестових класів. Найбільші групи:
...
| `tests/Security/` | 44 | CSRF вітрини й адмінки, походження запиту, вхід і відновлення пароля, вибирач файлів, обхід шляхів, заголовки, куки, SVG, хендлери логу |
