...
| `Entities/CleanDumpMatchesEntitiesTest` | оголосити сутності поле, якого немає в `okay_clean.sql` — свіжий стенд народиться з відсталою схемою, а сторінка мовчки віддасть порожній список |
