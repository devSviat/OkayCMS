...
Ненульовий код виходу — міграція впала або каталогу `1DB_changes/fork/` немає
взагалі. Друге буває на інсталяціях, які їдуть образом: збірка, що виключає
`1DB_changes/`, лишає команду без файлів, і без цієї перевірки вона мовчки
відрапортувала б «немає нових», а схема лишилась би відсталою. Якщо оновлюєтесь
образом — переконайтесь, що `1DB_changes/fork/` у нього потрапляє.

Коли міграція впала, команда друкує, що встигло застосуватись до падіння.
Формат файлів і обмеження діалекту —
