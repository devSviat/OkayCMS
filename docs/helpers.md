...
Хелпер виносить логіку з контролера — і бізнес-логіку, і логіку застосунку. Один метод хелпера
переви­користовується в кількох місцях системи, і, що важливіше, **будь-який його метод може
розширити модуль**. Тому правило просте: усе, що складніше за передачу даних у шаблон, живе в
хелпері, а не в контролері.
