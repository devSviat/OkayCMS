...
унікальне — під ним сервер веде перелік уже використаних токенів, тож дві форми з одним іменем
гаситимуть одна одну.

Значення нове на кожен рендер, а відсіює повтор саме перелік використаних. Це важливо для
поведінки: дві вкладки з тією самою формою мають різні токени й обидві проходять, а подвійний
клік шле один токен двічі, і другий запит відпадає.
