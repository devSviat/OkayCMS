...
файлы шаблона, стили, переводы, в точно такой же структуре [как в стандартном OkayCMS](./../architecture.md#карта-каталогів)
...
[стандартный дизайн OkayCMS](./../architecture.md#карта-каталогів)
