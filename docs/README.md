...
| Правити стилі адмінки | [admin-design.md](admin-design.md) |
...
* [Дизайн адмінки](admin-design.md) — токени, іконки, кільце фокуса, пари «на світлому / на темному»
...
* [Розгортання на FrankenPHP](deployment-frankenphp.md) — вебсервер стека з репозиторію, Caddyfile і свідомі розбіжності з nginx
* [Приклад конфігурації Nginx](nginx/nginx.conf) — для встановлення на власний nginx
