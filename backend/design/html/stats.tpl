...
<div class="row">
    <div class="col-lg-12 col-md-12">
        <div class="heading_page">{$btr->stats_stats|escape}
            <i class="fn_tooltips fn_tip_wide hint-bottom-middle-t-white-s-small-mobile hint-anim" data-hint="{$btr->tooltip_stats_stats|escape}" tabindex="0" role="img" aria-label="{$btr->tooltip_stats_stats|escape}">
