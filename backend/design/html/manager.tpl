                ...
                <div class="toggle_body_wrap on fn_card">
                    <div class="mb-1">
                        <div class="heading_label">{$btr->manager_login|escape}
                            <i class="fn_tooltips fn_tip_wide hint-bottom-left-t-white-s-small-mobile hint-anim" data-hint="{$btr->tooltip_manager_login|escape}" tabindex="0" role="img" aria-label="{$btr->tooltip_manager_login|escape}">
                    ...
                    <div class="mb-1">
                        <div class="heading_label">{$btr->manager_email|escape}
                            <i class="fn_tooltips fn_tip_wide hint-bottom-middle-t-white-s-small-mobile hint-anim" data-hint="{$btr->tooltip_manager_email|escape}" tabindex="0" role="img" aria-label="{$btr->tooltip_manager_email|escape}">
                                {include file='svg_icon.tpl' svgId='icon_tooltips'}
                            </i>
                        </div>
                        <div class="">
                    ...
                    <div class="mb-1">
                        <div class="heading_label">{$btr->manager_pass|escape}
                            <i class="fn_tooltips fn_tip_wide hint-bottom-left-t-white-s-small-mobile hint-anim" data-hint="{$btr->tooltip_manager_pass|escape}" tabindex="0" role="img" aria-label="{$btr->tooltip_manager_pass|escape}">
                                {include file='svg_icon.tpl' svgId='icon_tooltips'}
                            </i>
                        </div>
                        <div class="">
        ...
        <div class="col-lg-12 col-md-12">
            <div class="boxed fn_toggle_wrap min_height_230px">
                <div class="heading_box">
                    ...
                    <i class="fn_tooltips fn_tip_wide hint-bottom-middle-t-white-s-small-mobile hint-anim" data-hint="{$btr->tooltip_manager_rights|escape}" tabindex="0" role="img" aria-label="{$btr->tooltip_manager_rights|escape}">
                        {include file='svg_icon.tpl' svgId='icon_tooltips'}
                    </i>
                    <div class="toggle_arrow_wrap fn_toggle_card text-primary">
                        <a class="btn-minimize" href="javascript:;" ><span class="fn_icon_arrow">{include file='svg_icon.tpl' svgId='chevron_down'}</span></a>
