    ...
    <div class="col-lg-12 col-md-12">
        <div class="wrap_heading">
            <div class="box_heading heading_page">
                ...
                <i class="fn_tooltips fn_tip_wide hint-bottom-middle-t-white-s-small-mobile hint-anim" data-hint="{$btr->tooltip_reportstats_orders|escape}" tabindex="0" role="img" aria-label="{$btr->tooltip_reportstats_orders|escape}">
