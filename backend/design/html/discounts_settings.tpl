        ...
        <div class="sets_block col-lg-6 col-md-12 pr-0">
            ...
            <div class="boxed fn_toggle_wrap">
                <div class="heading_box">
                    ...
                    <i class="fn_tooltips fn_tip_wide hint-bottom-middle-t-white-s-small-mobile hint-anim" data-hint="{$btr->discounts_settings_purchase_sets_tooltip|escape}" tabindex="0" role="img" aria-label="{$btr->discounts_settings_purchase_sets_tooltip|escape}">
        ...
        <div class="sets_block col-lg-6 col-md-12">
            ...
            <div class="boxed fn_toggle_wrap">
                <div class="heading_box">
                    ...
                    <i class="fn_tooltips fn_tip_wide hint-bottom-middle-t-white-s-small-mobile hint-anim" data-hint="{$btr->discounts_settings_cart_sets_tooltip|escape}" tabindex="0" role="img" aria-label="{$btr->discounts_settings_cart_sets_tooltip|escape}">
                        {include file='svg_icon.tpl' svgId='icon_tooltips'}
                    </i>
                    <div class="box_btn_heading ml-1">
