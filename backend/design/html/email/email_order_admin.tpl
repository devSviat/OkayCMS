                                                                                    ...
                                                                                    <table width="100%" cellspacing="0" cellpadding="0">
                                                                                        ...
                                                                                        <tr>
                                                                                            <td>
                                                                                                ...
                                                                                                <span class="es-p5t"><em><span style="color: rgb(128, 128, 128); font-size: 14px;">{$purchase->variant_name|escape}</span></em></span>
                                                                                                {if !$order->closed && $purchase->variant->stock == 0}
                                                                                                <div class="es-p5t" style="color: #000; font-size: 14px;font-weight: 600">{$lang->product_pre_order|escape}</div>
                                                                                                {/if}
