...
<div class="row">
    <div class="col-md-12">
        <div class="wrap_heading">
            ...
            <i class="fn_tooltips fn_tip_wide hint-bottom-middle-t-white-s-small-mobile hint-anim" data-hint="{$btr->tooltip_title_chpu|escape}" tabindex="0" role="img" aria-label="{$btr->tooltip_title_chpu|escape}">
                            ...
                            <div class="activity_of_switch_item"> {* row block *}
                                <div class="okay_switch clearfix">
                                    <label class="switch_label">
                                        ...
                                        <i class="fn_tooltips fn_tip_wide hint-bottom-middle-t-white-s-small-mobile hint-anim" data-hint="{$btr->tooltip_settings_router_statuses|escape}" tabindex="0" role="img" aria-label="{$btr->tooltip_settings_router_statuses|escape}">
                                            {include file='svg_icon.tpl' svgId='icon_tooltips'}
                                        </i>
                                    </label>
                            ...
                            <div class="activity_of_switch_item left_indent"> {* row block *}
                                <div class="okay_switch clearfix">
                                    <label class="switch_label">
                                        ...
                                        <i class="fn_tooltips fn_tip_wide hint-bottom-middle-t-white-s-small-mobile hint-anim" data-hint="{$btr->page_routes_template_slash_end_notice|escape}" tabindex="0" role="img" aria-label="{$btr->page_routes_template_slash_end_notice|escape}">
                                            {include file='svg_icon.tpl' svgId='icon_tooltips'}
                                        </i>
                                    </label>
                                    <label class="switch switch-default">
                ...
                <div class="activity_of_switch_item settings_router_switch">
                    <div class="okay_switch clearfix">
                        <label class="switch_label">
                            ...
                            <i class="fn_tooltips fn_tip_wide hint-bottom-right-t-white-s-small-mobile hint-anim" data-hint="{$btr->settings_router_url_slash_end_notice|escape}" tabindex="0" role="img" aria-label="{$btr->settings_router_url_slash_end_notice|escape}">
                                {include file='svg_icon.tpl' svgId='icon_tooltips'}
                            </i>
                        </label>
                        <label class="switch switch-default">
            ...
            <div class="boxed fn_toggle_wrap">
                ...
                <div class="activity_of_switch_item settings_router_switch">
                    <div class="okay_switch clearfix">
                        <label class="switch_label">
                            {$btr->settings_router_url_slash_end|escape}
                            <i class="fn_tooltips fn_tip_wide hint-bottom-right-t-white-s-small-mobile hint-anim" data-hint="{$btr->settings_router_url_slash_end_notice}" tabindex="0" role="img" aria-label="{$btr->settings_router_url_slash_end_notice}">
                                {include file='svg_icon.tpl' svgId='icon_tooltips'}
                            </i>
                        </label>
                        <label class="switch switch-default">
