                    ...
                    <div class="col-lg-10 col-md-9 col-sm-12">
                        <div class="fn_step-1">
                            <div class="heading_label heading_label--required">
                                ...
                                <i class="fn_tooltips fn_tip_wide hint-bottom-left-t-white-s-small-mobile hint-anim" data-hint="{$btr->tooltip_general_name|escape}" tabindex="0" role="img" aria-label="{$btr->tooltip_general_name|escape}">
                            ...
                            <div class="fn_step-3 activity_of_switch_item"> {* row block *}
                                <div class="okay_switch clearfix">
                                    <label class="switch_label">
                                        ...
                                        <i class="fn_tooltips fn_tip_wide hint-bottom-right-t-white-s-small-mobile hint-anim" data-hint="{$btr->tooltip_general_enable|escape}" tabindex="0" role="img" aria-label="{$btr->tooltip_general_enable|escape}">
                                            {include file='svg_icon.tpl' svgId='icon_tooltips'}
                                        </i>
                                    </label>
                        ...
                        <div class="fn_step-4 activity_of_switch_item">
                            <div class="okay_switch clearfix">
                                <label class="switch_label">
                                    ...
                                    <i class="fn_tooltips fn_tip_wide hint-bottom-middle-t-white-s-small-mobile hint-anim" data-hint="{$btr->tooltip_general_bestseller|escape}" tabindex="0" role="img" aria-label="{$btr->tooltip_general_bestseller|escape}">
                                        {include file='svg_icon.tpl' svgId='icon_tooltips'}
                                    </i>
                                </label>
                                <label class="switch switch-default">
        ...
        <div class="col-lg-8 col-md-12 pr-0 ">
            <div class="fn_step-5 boxed fn_toggle_wrap min_height_230px">
                <div class="heading_box">
                    ...
                    <i class="fn_tooltips fn_tip_wide hint-bottom-middle-t-white-s-small-mobile hint-anim" data-hint="{$btr->tooltip_product_images|escape}" tabindex="0" role="img" aria-label="{$btr->tooltip_product_images|escape}">
                        {include file='svg_icon.tpl' svgId='icon_tooltips'}
                    </i>
                    <div class="toggle_arrow_wrap fn_toggle_card text-primary">
                        <a class="btn-minimize" href="javascript:;" ><span class="fn_icon_arrow">{include file='svg_icon.tpl' svgId='chevron_down'}</span></a>
            ...
            <div class="boxed min_height_230px">
                <div class="fn_step-6">
                    <div class="heading_label">
                        ...
                        <i class="fn_tooltips fn_tip_wide hint-bottom-middle-t-white-s-small-mobile hint-anim" data-hint="{$btr->tooltip_general_brand|escape}" tabindex="0" role="img" aria-label="{$btr->tooltip_general_brand|escape}">
                            {include file='svg_icon.tpl' svgId='icon_tooltips'}
                        </i>
                    </div>
                    <div class="">
                ...
                <div class="fn_step-7">
                    <div class="heading_label heading_label--required">
                        ...
                        <i class="fn_tooltips fn_tip_wide hint-bottom-middle-t-white-s-small-mobile hint-anim" data-hint="{$btr->tooltip_general_category|escape}" tabindex="0" role="img" aria-label="{$btr->tooltip_general_category|escape}">
                            {include file='svg_icon.tpl' svgId='icon_tooltips'}
                        </i>
                    </div>
                    <div id="product_cats" class="clearfix">
                        {assign var ='first_category' value=$product_categories|first}
        ...
        <div class="col-lg-12 col-md-12 ">
            <div class="fn_step-8 boxed fn_toggle_wrap">
                <div class="heading_box">
                    ...
                    <i class="fn_tooltips fn_tip_wide hint-bottom-left-t-white-s-small-mobile hint-anim" data-hint="{$btr->tooltip_general_options|escape}" tabindex="0" role="img" aria-label="{$btr->tooltip_general_options|escape}">
                        {include file='svg_icon.tpl' svgId='icon_tooltips'}
                    </i>
                    <div class="toggle_arrow_wrap fn_toggle_card text-primary">
                        <a class="btn-minimize" href="javascript:;" ><span class="fn_icon_arrow">{include file='svg_icon.tpl' svgId='chevron_down'}</span></a>
                                    ...
                                    <div class="okay_list_row">
                                        ...
                                        <div class="okay_list_boding variants_item_sku">
                                            <div class="heading_label">
                                                ...
                                                <i class="fn_tooltips fn_tip_wide hint-bottom-middle-t-white-s-small-mobile hint-anim" data-hint="{$btr->tooltip_general_sku|escape}" tabindex="0" role="img" aria-label="{$btr->tooltip_general_sku|escape}">
                                                    {include file='svg_icon.tpl' svgId='icon_tooltips'}
                                                </i>
                                            </div>
                                        ...
                                        <div class="okay_list_boding variants_item_weight">
                                            <div class="heading_label">
                                                ...
                                                <i class="fn_tooltips fn_tip_wide hint-bottom-middle-t-white-s-small-mobile hint-anim" data-hint="{$btr->tooltip_general_weight|escape}" tabindex="0" role="img" aria-label="{$btr->tooltip_general_weight|escape}">
                                                    {include file='svg_icon.tpl' svgId='icon_tooltips'}
                                                </i>
                                            </div>
        ...
        <div class="col-lg-8 col-md-12 pr-0 ">
            <div class="fn_step-9 boxed fn_toggle_wrap min_height_230px">
                <div class="heading_box">
                    ...
                    <i class="fn_tooltips fn_tip_wide hint-bottom-middle-t-white-s-small-mobile hint-anim" data-hint="{$btr->tooltip_product_promotions|escape}" tabindex="0" role="img" aria-label="{$btr->tooltip_product_promotions|escape}">
                        {include file='svg_icon.tpl' svgId='icon_tooltips'}
                    </i>
                    <div class="toggle_arrow_wrap fn_toggle_card text-primary">
                        <a class="btn-minimize" href="javascript:;" ><span class="fn_icon_arrow">{include file='svg_icon.tpl' svgId='chevron_down'}</span></a>
                ...
                <div class="heading_tabs">
                    <div class="tab_navigation">
                        ...
                        <a href="#tab2" class="heading_box tab_navigation_link">
                            ...
                            <i style="right: -8px" class="fn_tooltips fn_tip_wide hint-bottom-middle-t-white-s-small-mobile hint-anim" data-hint="{$btr->tooltip_general_full_description|escape}" tabindex="0" role="img" aria-label="{$btr->tooltip_general_full_description|escape}">
                                {include file='svg_icon.tpl' svgId='icon_tooltips'}
                            </i>
                        </a>
                    </div>
...
<script>
    $(window).on("load", function() {
        ...
        // infinity
        $("input[name*=variant][name*=stock]").on('focus', function() {
            if($(this).val() == '∞')
                $(this).val('');
            return false;
        });

        $("input[name*=variant][name*=stock]").on('blur', function() {
            if($(this).val() == '')
                $(this).val('∞');
        });
    });
