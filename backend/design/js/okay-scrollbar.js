/**
 * Малює смугу прокрутки поверх вмісту для елементів із класом
 * fn_scroll_overlay. Потрібна там, де рідна смуга зайняла б ширину контейнера
 * й посунула вміст, - у бічному меню.
 *
 * Прокрутку не підміняє: колесо, клавіші й тач лишаються рідними, скрипт лише
 * показує положення й дає тягнути повзунок. Батько контейнера має бути
 * позиційованим - доріжка кладеться в нього.
 */
(function () {
    'use strict';
