...
$config = array(
    ...
    */
    ...
    'previewable_text_file_exts'              => array( "bsh", "c", "cc", "cpp", "cs", "csh", "cyc", "cv", "java", "m", "mxml", "perl", "pl", "pm", "py", "rb", "sh", 'txt', 'log' ),

    // you can edit these type of files if $edit_text_files is true (only text based files)
    // you can create these type of files if $config['create_text_files'] is true (only text based files)
    // Активний веб-контент (html, css, js, xml) сюди не додавати: файл лягає
    // в files/ і віддається браузеру з домену магазину.
