...
try {
    ...
    // Загрузка по произвольному URL удалена: она превращала админский
    // файловый менеджер в SSRF-примитив (curl на любой адрес, видимый
    // серверу, включая внутреннюю сеть и метаданные облака).
