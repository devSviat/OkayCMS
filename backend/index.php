...
// Порядок оголошення важливий: усередині try{} функція визначалася б лише
// коли виконання дійде до неї, а викликають її раніше.
...
// Response::redirectTo() і рання відсічка завершують запит розкруткою стека.
// Адмінка працює в classic mode, тож ловити її, крім точки входу, нема кому.
try {
    ...
    // Відповідь уже віддана: редірект або рання відсічка.
}
