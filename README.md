...
Три речі, які форк додає до апстрімної OkayCMS v4.5.2:
 ...
 - **`vibe_shop` — нова тема вітрини.** Повний редизайн, адаптивний на телефонах і планшетах в
   ...
   Стокова тема лишилась у комплекті, але не в стоковому вигляді — 10 файлів довелось привести
   до POST-мутацій і CSRF-токена ([`docs/theme-porting.md`](docs/theme-porting.md)).
