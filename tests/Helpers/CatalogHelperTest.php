...
/**
 * Guards Okay\Helpers\CatalogHelper against the PHP 8.4+ implicit-nullable
...
class CatalogHelperTest extends TestCase
{
    public function testHasNoImplicitNullableDeprecation(): void
    {
        ...
        $script = 'set_error_handler(function ($no, $str) {'
            ...
            . 'class_exists(' . var_export(CatalogHelper::class, true) . ');'
            . 'exit(0);';
        ...
        $this->assertSame(
            0,
            $exitCode,
            CatalogHelper::class . ' emits an implicit-nullable deprecation on PHP 8.4+:' . PHP_EOL . implode(PHP_EOL, $output)
        );
    }
}
