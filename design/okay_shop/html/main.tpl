                                            ...
                                            {if $b->image}
                                                <div class="d-flex align-items-center justify-content-center main_brands__image">
                                                    <picture>
                                                        ...
                                                        <img class="main_brands_img lazy" data-src="{$b->image|resize:100:50:false:$config->resized_brands_dir}" src="{$rootUrl}/design/{get_theme}/images/loading.svg" alt="{$b->name|escape}" title="{$b->name|escape}"/>
                                                    </picture>
                                                </div>
                                            {else}
