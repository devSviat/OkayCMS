...
<body class="d-flex flex-column {if $controller == 'MainController'}main_page{elseif $controller == 'CartController'}cart_page{else}other_page{/if}">
                    ...
                    <div class="header__bottom_panel f_row no_gutters flex-nowrap align-content-stretch justify-content-between">
                        ...
                        {if !empty({$settings->site_logo})}
                            <a class="logo__link "
                                ...
                                {else}
                                    <img src="{$rootUrl}/{$config->design_images|escape}{$settings->site_logo|escape}?v={$settings->site_logo_version|escape}"
    ...
    {* Кнопка на верх *}
    <div class="fn_to_top to_top">{include file="svg.tpl" svgId="arrow-up"}</div>
