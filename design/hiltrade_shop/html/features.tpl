                                        ...
                                        >
                                            {if $c->image}
                                                <picture>
                                                    ...
                                                    <img class="lazy" data-src="{$c->image|resize:20:20:false:$config->resized_categories_dir}" src="{$rootUrl}/design/{get_theme}/images/loading.svg" alt="{$c->name|escape}" title="{$c->name|escape}"/>
                                                </picture>
                                            {else}
