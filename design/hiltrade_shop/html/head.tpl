    ...
    <link href="{$rootUrl}/design/{$settings->theme}/fonts/manrope/Manrope-SemiBold.woff2" rel="preload" as="font" crossorigin="anonymous" type="font/woff2">
    <link href="{$rootUrl}/design/{$settings->theme}/fonts/manrope/Manrope-Bold.woff2" rel="preload" as="font" crossorigin="anonymous" type="font/woff2">
    <link href="{$rootUrl}/design/{$settings->theme}/fonts/manrope/Manrope-Regular.woff2" rel="preload" as="font" crossorigin="anonymous" type="font/woff2">
    <link href="{$rootUrl}/design/{$settings->theme}/fonts/manrope/Manrope-Medium.woff2" rel="preload" as="font" crossorigin="anonymous" type="font/woff2">
    ...
    <style>
        @font-face {
            ...
            url('{$rootUrl}/design/{$settings->theme}/fonts/manrope/Manrope-SemiBold.woff2') format('woff2'),
            url('{$rootUrl}/design/{$settings->theme}/fonts/manrope/Manrope-SemiBold.woff') format('woff');
            font-weight: 600;
            font-style: normal;
        }
        @font-face {
            ...
            url('{$rootUrl}/design/{$settings->theme}/fonts/manrope/Manrope-Bold.woff2') format('woff2'),
            url('{$rootUrl}/design/{$settings->theme}/fonts/manrope/Manrope-Bold.woff') format('woff');
            font-weight: bold;
            font-style: normal;
        }
        @font-face {
            ...
            url('{$rootUrl}/design/{$settings->theme}/fonts/manrope/Manrope-Regular.woff2') format('woff2'),
            url('{$rootUrl}/design/{$settings->theme}/fonts/manrope/Manrope-Regular.woff') format('woff');
            font-weight: normal;
            font-style: normal;
        }
        @font-face {
        ...
        url('{$rootUrl}/design/{$settings->theme}/fonts/manrope/Manrope-Medium.woff2') format('woff2'),
        url('{$rootUrl}/design/{$settings->theme}/fonts/manrope/Manrope-Medium.woff') format('woff');
        font-weight: 500;
        font-style: normal;
        }
    </style>
    ...
    <meta name="generator" content="Hiltrade {$config->version}">
