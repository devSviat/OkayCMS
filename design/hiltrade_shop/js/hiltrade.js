...
$(function () {
  ...
  $(".fn_catalog_switch").click(function (e) {
    ...
    $(".fn_catalog_menu").slideToggle(10);

    if ($(this).hasClass("active")) {
        $(this).removeClass("active");
        $(".fn_catalog_menu").removeClass("show");
        $(".fn_catalog_menu").addClass("hide");
    } else {
        $(this).addClass("active");
        $(".fn_catalog_menu").addClass("show");
        $(".fn_catalog_menu").removeClass("hide");
    }
  });
...
//       },
//       utilsScript:
//         "https://cdnjs.cloudflare.com/ajax/libs/intl-tel-input/18.2.1/js/utils.js" // just for
//     });
