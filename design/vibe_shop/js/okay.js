...
$(document).on(
  ...
  function (e) {
    ...
    /* Перехід міг і не статись: Esc, обрив звʼязку, помилка сервера. Документ
       лишається живим, тому прапорець мусить сам відпускати форму, інакше
       кнопка перестає реагувати назавжди. */
    setTimeout(function () {
