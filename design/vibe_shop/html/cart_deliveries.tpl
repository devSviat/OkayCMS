                        ...
                        {if $delivery->image}
                            <span class="vs-option-card__logo">
                                <picture>
                                    ...
                                    <img class="lazy" data-src="{$delivery->image|resize:80:30:false:$config->resized_deliveries_dir}" src="{$rootUrl}/design/{get_theme}/images/xloading.gif" alt="" title="{$delivery->name|escape}"/>
                                </picture>
                            </span>
                        {/if}
                    </label>
                                ...
                                {if $payment_method->image}
                                    <span class="vs-option-card__logo">
                                        <picture>
                                            ...
                                            <img class="lazy" data-src="{$payment_method->image|resize:80:30:false:$config->resized_payments_dir}" src="{$rootUrl}/design/{get_theme}/images/xloading.gif" alt="" title="{$payment_method->name|escape}"/>
                                        </picture>
                                    </span>
                                {/if}
                            </label>
