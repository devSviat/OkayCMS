...
{/if}
{if $svgId == "exit_icon"}
    <svg width="30px" height="30px" viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="1.8" stroke-linecap="round" stroke-linejoin="round" aria-hidden="true" focusable="false">
...
{/if}
{if $svgId == "home_icon"}
    <svg width="20px" height="20px" viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="1.8" stroke-linecap="round" stroke-linejoin="round" aria-hidden="true" focusable="false">
...
{/if}
{if $svgId == "no_image"}
    <svg width="26px" height="26px" viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="1.8" stroke-linecap="round" stroke-linejoin="round" aria-hidden="true" focusable="false">
        <path d="M15 8h.01"/>
...
{/if}
{if $svgId == "sort_icon"}
    <svg class="sorting_icon" width="16px" height="16px" viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="1.8" stroke-linecap="round" stroke-linejoin="round" aria-hidden="true" focusable="false">
        <title>Sorting</title>
        {* tabler: arrows-sort. The class marks the sort direction the half stands *}
        {* for, not its position - the ascending arrow is the left one here.       *}
        <path class="sorting_icon--asc" d="M3 9l4 -4l4 4m-4 -4v14"/>
        <path class="sorting_icon--desc" d="M21 15l-4 4l-4 -4m4 4v-14"/>
    </svg>
{/if}
...
{if $svgId == "remove_icon"}
    <svg class="remove_icon" width="20" height="20" viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="1.8" stroke-linecap="round" stroke-linejoin="round" aria-hidden="true" focusable="false">
        <path d="M18 6l-12 12"/>
        <path d="M6 6l12 12"/>
    </svg>
{/if}
...
{if $svgId == "success_icon"}
    <svg width="28px" height="28px" viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="1.8" stroke-linecap="round" stroke-linejoin="round" aria-hidden="true" focusable="false">
        <path d="M3 12a9 9 0 1 0 18 0a9 9 0 1 0 -18 0"/>
...
{/if}
{if $svgId == "404_icon"}
    {* Stroke width is in viewBox units, so it scales with the box. This one is *}
    {* drawn far larger than the rest (.vs-404__mark sizes it), so 1.8 would    *}
    {* render as a slab. 0.7 holds the optical weight of the 24px icons.        *}
    <svg width="88px" height="88px" viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="0.7" stroke-linecap="round" stroke-linejoin="round" aria-hidden="true" focusable="false">
...
{if $svgId == "time_read_icon"}
    <svg width="24px" height="24px" viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="1.8" stroke-linecap="round" stroke-linejoin="round" aria-hidden="true" focusable="false">
