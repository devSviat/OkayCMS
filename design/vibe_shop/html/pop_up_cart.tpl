        ...
        <div class="vs-popcart__lines vs-cart__lines">
            {foreach $cart->purchases as $purchase}
                <article class="fn_purchase_row vs-cart__line vs-cart__line--compact">
                    ...
                    {* Remove button *}
                    <a class="vs-btn vs-btn--ghost vs-btn--icon vs-cart__remove" href="{url_generator route="cart_remove_item" variantId=$purchase->variant->id}" onclick="ajax_remove({$purchase->variant->id});return false;" title="{$lang->cart_remove}" aria-label="{$lang->cart_remove|escape}">
