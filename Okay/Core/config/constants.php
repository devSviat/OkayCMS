...
// Скільки записів віддає page-all. Без стелі сторінка вантажить увесь лістинг
// одним запитом і на великому каталозі вичерпує пам'ять PHP ще до рендера.
const PAGE_ALL_MAX_ITEMS = 1000;

// Нуль означає, що page-all віддає звичайну першу сторінку, а кнопка «всі»
// зникає з теми.
const PAGE_ALL_OFF = 0;

// Перелік для вибору в адмінці. Верхня межа не косметична: вище неї page-all
// знову впирається в пам'ять.
const PAGE_ALL_ALLOWED_ITEMS = [PAGE_ALL_OFF, 500, 1000, 2000, 3000];
