...
class SvgSanitizer
{
    ...
    public function sanitize($svg)
    {
        ...
        // LIBXML_NONET и отсутствие LIBXML_NOENT не дают резолвить
        // внешние сущности (XXE).
    ...
    /**
     * Санитайзит файл на месте. Возвращает false и не трогает файл,
     * если содержимое не является разбираемым SVG.
     */
