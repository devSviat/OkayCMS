...
class PathResolver
{
     ...
     *
     * Єдиний відсів на вході процедурних точок файлового менеджера: там шлях
     * склеюється з конфігом у двох десятках місць, і переписувати кожне
     * небезпечніше, ніж відхилити запит цілком.
     *
     * @param mixed $value
     * @return bool
     */
