            ...
            <div class="boxed_sorting action_options">
                <div class="row">
                    <div class="col-md-3 col-lg-3 col-sm-12">
                        <span>{$btr->inform_show_quantity}</span>
                                ...
                                <div class="fn_row okay_list_body_item fn_sort_item">
                                    <div class="okay_list_row ">
                                        ...
                                        <div class="okay_list_boding okay_list_photo">
                                            {if $product->image}
                                                <a href="{url controller=ProductAdmin id=$product->id return=$smarty.server.REQUEST_URI}" target="_blank">
                                                    <img src="{$product->image->filename|escape|resize:35:35}"/></a>
                                            {else}
                                        ...
                                        <div class="okay_list_boding okay_list_name">
                                            <a href="{url controller=ProductAdmin id=$product->id return=$smarty.server.REQUEST_URI}" target="_blank">{$product->name|escape}</a>
