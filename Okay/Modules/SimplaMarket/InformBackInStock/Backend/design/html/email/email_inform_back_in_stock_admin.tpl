{$subject="`$btr->inform_title` `$rec->name|escape`" scope=global}
{$subject}
                                                    ...
                                                    <table width="100%" cellspacing="0" cellpadding="0">
                                                        ...
                                                        <tr>
                                                            <td class="es-p10t es-p15b" align="center">
                                                                <h1>{$btr->email_new_inform_stock|escape}.<br></h1>
                                                            </td>
                                                        </tr>
                                                        </tbody>
                                                    </table>
                                            ...
                                            <tr>
                                                <td class="es-m-p20b" width="100%" align="left">
                                                    <table class="es-table-infobox" cellspacing="1" cellpadding="1" border="0" align="left">
                                                        <tbody>
                                                        <tr valign="top">
                                                            <td class="es-p5t es-p5b" width="180"><span>{$btr->inform_stock_name_admin_email|escape}:</span></td>
                                                            <td class="es-p5t es-p5b"><span>{$rec->name|escape}</span></td>
                                                        </tr>
                                                        <tr valign="top">
                                                            <td class="es-p5t es-p5b" width="180"><span>{$btr->inform_stock_email_admin_email|escape}:</span></td>
                                                            <td class="es-p5t es-p5b"><span>{$rec->email|escape}</span></td>
                                                        </tr>
                                                        <tr valign="top">
                                                            <td class="es-p5t es-p5b" width="180"><span>{$btr->inform_stock_product_admin_email|escape}:</span></td>
                                                            <td class="es-p5t es-p5b"><span><a href="{url_generator route="product" url=$rec->product->url absolute=1}">{$rec->product->name}</a></span></td>
                                                        </tr>
