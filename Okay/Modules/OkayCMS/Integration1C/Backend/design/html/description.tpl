                                            ...
                                            <div class="col-xl-12 col-lg-12 col-md-12">
                                                <div class="permission_box permission_box--long">
                                                    <span>
                                                        ...
                                                        <i class="fn_tooltips fn_tip_wide hint-bottom-middle-t-white-s-small-mobile hint-anim" data-hint="{$btr->okaycms__integration_1c__settings_exportPurchasesDiscountsSeparate_tooltip|escape}" tabindex="0" role="img" aria-label="{$btr->okaycms__integration_1c__settings_exportPurchasesDiscountsSeparate_tooltip|escape}">
