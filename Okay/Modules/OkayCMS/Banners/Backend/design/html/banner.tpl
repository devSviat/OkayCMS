                        ...
                        <div class="">
                            <div class="heading_label">
                                <span class="boxes_inline heading_label">
                                    ...
                                    <i class="fn_tooltips fn_tip_wide hint-bottom-middle-t-white-s-small-mobile hint-anim" data-hint="{$btr->banner_faq_id_group|escape}" tabindex="0" role="img" aria-label="{$btr->banner_faq_id_group|escape}">
                        ...
                        <div class="activity_of_switch activity_of_switch--left mt-2">
                            <div class="activity_of_switch_item">
                                <span class="okay_switch okay_switch--nowrap clearfix">
                                    ...
                                    <i class="fn_tooltips fn_tip_wide hint-bottom-middle-t-white-s-small-mobile hint-anim" data-hint="{$btr->banner_individual_shortcode_description|escape}" tabindex="0" role="img" aria-label="{$btr->banner_individual_shortcode_description|escape}">
                                        {include file='svg_icon.tpl' svgId='icon_tooltips'}
                                    </i>
                                </label>
                                </span>
                        ...
                        <div class="permission_boxes row">
                            ...
                            <div class="col-xl-4 col-lg-4 col-md-6 text-muted">
                                <div class="permission_box">
                                    ...
                                    <i class="fn_tooltips fn_tip_wide hint-bottom-right-t-white-s-small-mobile hint-anim" data-hint="{$btr->banner_settings_rotation_speed_title|escape}" tabindex="0" role="img" aria-label="{$btr->banner_settings_rotation_speed_title|escape}">
                                        {include file='svg_icon.tpl' svgId='icon_tooltips'}
                                    </i>
