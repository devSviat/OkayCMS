                ...
                <div class="col-md-12  mb-2">
                    ...
                    <div class="mt-2">
                        <div class="heading_label heading_label--required">
                            ...
                            <i class="fn_tooltips fn_tip_wide hint-bottom-middle-t-white-s-small-mobile hint-anim" data-hint="Правильный description должен содержать ключевые слова, под которые вы намерены продвигать страницу. Самые частотные запросы должны быть расположены в начале описания. Не используйте в мета-теге более 3-4 ключевых фраз. Одно и то же слово не следует повторять более 5-7 раз" tabindex="0" role="img" aria-label="Правильный description должен содержать ключевые слова, под которые вы намерены продвигать страницу. Самые частотные запросы должны быть расположены в начале описания. Не используйте в мета-теге более 3-4 ключевых фраз. Одно и то же слово не следует повторять более 5-7 раз">
...
<div class="heading_label">
    <span>Заголовок</span>
    <i class="fn_tooltips hint-bottom-middle-t-white-s-small-mobile hint-anim" data-hint="Текст подсказки" tabindex="0" role="img" aria-label="Текст подсказки">
    {include file='svg_icon.tpl' svgId='icon_tooltips'}
    </i>
</div>
                        </textarea>
