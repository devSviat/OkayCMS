                                                ...
                                                <div class="row">
                                                    <div class="col-md-6">
                                                        <div class="form-group">
                                                            <div class="heading_label">
                                                                <span>URL</span>
                                                                <i class="fn_tooltips fn_tip_wide hint-bottom-left-t-white-s-small-mobile hint-anim" data-hint="{$btr->okaycms__google_merchant__error_url_cyrillic|escape}" tabindex="0" role="img" aria-label="{$btr->okaycms__google_merchant__error_url_cyrillic|escape}">
