...
class BackendEpitsentrAdapter extends AbstractBackendPresetAdapter
{
    /** @var string */
    protected static $settingsTemplate = 'presets/epitsentr/settings.tpl';
    ...
    public function postSettings(): array
    {
        ...
        $settings = [
            ...
            'brands_external_ids' => $postSettings['brands_external_ids'] ?? [],
            'filter_price' => [
    ...
    public function registerCategorySettingsBlock(): void
    {
        $this->designBlocks->registerBlock(
            ...
            dirname(__DIR__, 3).'/design/html/presets/epitsentr/category_settings.tpl'
        );
