{if $feed}
    ...
    <div class="boxed fn_features_settings hidden-xs-down">
        <div class="heading_box">
            ...
            <i class="fn_tooltips fn_tip_wide hint-bottom-middle-t-white-s-small-mobile hint-anim" data-hint="{$btr->okay_cms__feeds__feed__features_settings__faq|escape}" tabindex="0" role="img" aria-label="{$btr->okay_cms__feeds__feed__features_settings__faq|escape}">
