{if $feed}
    ...
    <div class="boxed fn_categories_settings hidden-xs-down">
        <div class="heading_box">
            ...
            <i class="fn_tooltips hint-bottom-middle-t-white-s-small-mobile hint-anim" data-hint="{$btr->okay_cms__feeds__feed__categories_settings__faq|escape}" tabindex="0" role="img" aria-label="{$btr->okay_cms__feeds__feed__categories_settings__faq|escape}">
