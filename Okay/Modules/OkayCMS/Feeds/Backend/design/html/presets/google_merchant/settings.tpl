                ...
                <div class="activity_of_switch_item">
                    <div class="okay_switch clearfix">
                        <label class="switch_label">
                            ...
                            <i class="fn_tooltips hint-bottom-middle-t-white-s-small-mobile hint-anim" data-hint="{$btr->okay_cms__feeds__feed__settings__google_merchant__description_in_html_info|escape}" tabindex="0" role="img" aria-label="{$btr->okay_cms__feeds__feed__settings__google_merchant__description_in_html_info|escape}">
