    ...
    <div class="row">
        <div class="col-md-6">
            <div class="heading_label">
                <span>{$btr->okay_cms__feeds__feed__settings__epitsentr__company}</span>
            </div>
            <div class="mb-1">
        ...
        <div class="col-md-6">
            <div class="heading_label">
                <span>{$btr->okay_cms__feeds__feed__settings__epitsentr__feed_name}</span>
            </div>
            <div class="mb-1">
        ...
        <div class="col-lg-12 col-md-12">
            <div class="activity_of_switch activity_of_switch--box_settings">
                <div class="activity_of_switch_item">
                    <div class="okay_switch clearfix">
                        <label class="switch_label">
                           <span>{$btr->okay_cms__feeds__feed__settings__epitsentr__store|escape}</span>
                        </label>
                ...
                <div class="activity_of_switch_item">
                    <div class="okay_switch clearfix">
                        <label class="switch_label">
                           <span>{$btr->okay_cms__feeds__feed__settings__epitsentr__pickup|escape}</span>
                        </label>
                        <label class="switch switch-default">
                ...
                <div class="activity_of_switch_item">
                    <div class="okay_switch clearfix">
                        <label class="switch_label">
                           <span>{$btr->okay_cms__feeds__feed__settings__epitsentr__has_manufacturer_warranty|escape}</span>
                        </label>
                        <label class="switch switch-default">
                ...
                <div class="activity_of_switch_item">
                    <div class="okay_switch clearfix">
                        <label class="switch_label">
                            <span>{$btr->okay_cms__feeds__feed__settings__epitsentr__delivery|escape}</span>
                        </label>
                        <label class="switch switch-default">
                ...
                <div class="activity_of_switch_item">
                    <div class="okay_switch clearfix">
                        <label class="switch_label">
                            <span>{$btr->okay_cms__feeds__feed__settings__epitsentr__adult|escape}</span>
                        </label>
                        <label class="switch switch-default">
                ...
                <div class="activity_of_switch_item">
                    <div class="okay_switch clearfix">
                        <label class="switch_label">
                            <span>{$btr->okay_cms__feeds__feed__settings__epitsentr__enable_auto_discounts|escape}</span>
                        </label>
                        <label class="switch switch-default">
                ...
                <div class="activity_of_switch_item">
                    <div class="okay_switch clearfix">
                        <label class="switch_label">
                            <span>{$btr->okay_cms__feeds__feed__settings__epitsentr__count|escape}</span>
                        </label>
                        <label class="switch switch-default">
...
<div class="boxed">
    ...
    <div class="row">
        <div class="col-md-6">
            <div class="heading_label">
                <span>{$btr->okay_cms__feeds__feed__settings__epitsentr__country_of_origin}</span>
            </div>
            <div class="mb-1">
        ...
        <div class="col-lg-12 col-md-12">
            <div class="activity_of_switch activity_of_switch--box_settings">
                <div class="activity_of_switch_item">
                    <div class="okay_switch clearfix">
                        <label class="switch_label">
                           <span>{$btr->okay_cms__feeds__feed__settings__epitsentr__upload_without_images|escape}</span>
                        </label>
                        <label class="switch switch-default">
                ...
                <div class="activity_of_switch_item">
                    <div class="okay_switch clearfix">
                        <label class="switch_label">
                           <span>{$btr->okay_cms__feeds__feed__settings__epitsentr__upload_only_in_stock_products|escape}</span>
                        </label>
                        <label class="switch switch-default">
                ...
                <div class="activity_of_switch_item">
                    <div class="okay_switch clearfix">
                        <label class="switch_label">
                           <span>{$btr->okay_cms__feeds__feed__settings__epitsentr__no_export_without_price|escape}</span>
                        </label>
                        <label class="switch switch-default">
                ...
                <div class="activity_of_switch_item">
                    <div class="okay_switch clearfix">
                        <label class="switch_label">
                            <span>{$btr->okay_cms__feeds__feed__settings__epitsentr__use_full_description|escape}</span>
                        </label>
                        <label class="switch switch-default">
                ...
                <div class="activity_of_switch_item">
                    <div class="okay_switch clearfix">
                        <label class="switch_label">
                            <span>{$btr->okay_cms__feeds__feed__settings__epitsentr__description_in_html|escape}</span>
                            <i class="fn_tooltips" title="{$btr->okay_cms__feeds__feed__settings__epitsentr__description_in_html_info|escape}">
...
<div class="boxed">
    <div class="heading_box">
        {$btr->okay_cms__feeds__feed__settings__epitsentr__brands_external_ids|escape}
    </div>
    <div class="row">
        {foreach $brands as $brand}
            <div class="col-md-3 col-sm-6">
                ...
                <div class="mb-1">
                    <input class="form-control" type="text" name="settings[brands_external_ids][{$brand->id}]" value="{if isset($feed->settings['brands_external_ids'][$brand->id])}{$feed->settings['brands_external_ids'][$brand->id]|escape}{/if}" placeholder="{$btr->okay_cms__feeds__feed__settings__epitsentr__brand_external_id_placeholder|escape}" />
                </div>
            </div>
        {/foreach}
    </div>
...
{$block = {get_design_block block="okay_cms__feeds__feed__settings__epitsentr__custom_block"}}
{if !empty($block)}
    <div class="boxed">
