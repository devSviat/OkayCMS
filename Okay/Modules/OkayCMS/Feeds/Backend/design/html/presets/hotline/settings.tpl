    ...
    <div class="row">
        ...
        <div class="col-md-6">
            <div class="heading_label">
                ...
                <i class="fn_tooltips hint-bottom-middle-t-info-s-small-mobile hint-anim" data-hint="{$btr->okay_cms__feeds__feed__settings__hotline__firm_id_faq|escape}">
                ...
                <div class="activity_of_switch_item">
                    <div class="okay_switch clearfix">
                        <label class="switch_label">
                            ...
                            <i class="fn_tooltips hint-bottom-middle-t-info-s-small-mobile hint-anim" data-hint="{$btr->okay_cms__feeds__feed__settings__hotline__description_in_html_info|escape}">
