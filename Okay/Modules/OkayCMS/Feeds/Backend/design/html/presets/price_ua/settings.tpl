        ...
        <div class="col-md-6">
            <div class="heading_label">
                <span>{$btr->okay_cms__feeds__feed__settings__price_ua__country_of_origin}</span>
                 <i class="fn_tooltips hint-bottom-middle-t-white-s-small-mobile hint-anim" data-hint="{$btr->okay_cms__feeds__feed__settings__price_ua__country_of_origin_tooltip|escape}" tabindex="0" role="img" aria-label="{$btr->okay_cms__feeds__feed__settings__price_ua__country_of_origin_tooltip|escape}">
                ...
                <div class="activity_of_switch_item">
                    <div class="okay_switch clearfix">
                        <label class="switch_label">
                            ...
                            <i class="fn_tooltips hint-bottom-middle-t-white-s-small-mobile hint-anim" data-hint="{$btr->okay_cms__feeds__feed__settings__price_ua__description_in_html_info|escape}" tabindex="0" role="img" aria-label="{$btr->okay_cms__feeds__feed__settings__price_ua__description_in_html_info|escape}">
