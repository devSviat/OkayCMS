...
use Okay\Modules\OkayCMS\Feeds\Backend\Core\Presets\Adapters\BackendEpitsentrAdapter;
        ...
        'okay_cms' => [
            'feeds' => [
                'presets' => [
                    ...
                    'Epitsentr' => [
                        'backend_adapter' => BackendEpitsentrAdapter::class,
                        'frontend_adapter' => EpitsentrAdapter::class
                    ],
                    'YML' => [
