 ...
 *
 * Винесено з PaymentForm і CallbackController: підпис був продубльований
 * інлайном, а кожна гілка контролера завершується exit; — тестом не накрити.
 */
class LiqPayProtocol
{
     ...
     * так дефект і виглядав — одна пара ключ-значення в масиві.
     */
    ...
    /**
     * order_id має вигляд "<id>-<випадкове число>". Усе інше дає 0 — на 0
     * замовлення не знаходиться й колбек відхиляється.
     */
