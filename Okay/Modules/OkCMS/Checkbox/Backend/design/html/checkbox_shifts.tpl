{$meta_title = $btr->okcms__checkbox_shifts scope=global}
...
<div class="main_header">
    <div class="main_header__item">
        <div class="main_header__inner">
            <div class="box_heading heading_page">
                {$btr->okcms__checkbox_shifts|escape}
            </div>
        </div>
    </div>
    <div class="main_header__item main_header__item--sort_date">
        <form class="box_date_filter fn_date_filter main_header__inner" method="get">
            <input type="hidden" name="controller" value="OkCMS.Checkbox.CheckboxShiftsAdmin">
