    ...
    public function render(
        ...
        if (isset($_POST['checkout'])) {
            ...
            if ($error = $validateHelper->getCartValidateError($order)) {
                ...
                // Замовлення з порожнього кошика не буває. Але сам по собі
                // порожній кошик ще не означає повтору: покупець міг прибрати
                // останню позицію в сусідній вкладці. Тоді редирект на
                // останнє замовлення сесії показував би підтвердження
                // замовлення, якого він щойно не робив, - разом із листом,
                // якого не було.
                //
